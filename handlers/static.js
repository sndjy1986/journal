...
function setupEventListeners() {
    ...
    document.getElementById('save-btn').addEventListener('click', handleSaveEntry);
    ...
    document.getElementById('export-json').addEventListener('click', () => exportEntries('json'));
    document.getElementById('export-txt').addEventListener('click', () => exportEntries('txt'));
    document.getElementById('cancel-export').addEventListener('click', () => document.getElementById('export-modal').classList.remove('active'));
    ...
    document.getElementById('font-selector').addEventListener('change', e => {
        document.getElementById('journal-entry').style.fontFamily = e.target.value;
    });
    
    // Sidebar Event Listeners
    document.getElementById('sidebar-toggle').addEventListener('click', toggleSidebar);
    document.getElementById('close-viewer').addEventListener('click', closeEntryViewer);
    ...
    // Writing Prompt
    document.getElementById('new-prompt-btn').addEventListener('click', showRandomPrompt);
    
    // Tags Input
    document.getElementById('entry-tags').addEventListener('input', handleTagInput);
    document.getElementById('entry-tags').addEventListener('focus', showTagSuggestions);
    document.getElementById('entry-tags').addEventListener('blur', () => {
        setTimeout(() => document.getElementById('tag-suggestions').style.display = 'none', 200);
    });
    
    // Writing Stats
    document.getElementById('journal-entry').addEventListener('input', updateWritingStats);
