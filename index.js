...
<body>
    ...
    <script>
        // API Configuration - Replace with your actual Cloudflare Worker URL
        const apiUrl = window.location.origin; // Uses current domain
        ...
        window.addEventListener('load', () => {
            ...
            const formElements = document.querySelectorAll('.input-group, .btn, .mood-options');
